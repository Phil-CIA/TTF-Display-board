...
1. `ELECROW_CROWPANEL_43_CHANNEL_CAPABILITY_PROFILE.md` — authoritative map of what the PSU hardware can actually do. **Read this first.** All UI rules derive from it.
2. `ELECROW_CROWPANEL_43_OPERATIONS_CONTRACT.md` — state machine, control authority, UART protocol, and safety rules.
3. `ELECROW_CROWPANEL_43_SCREEN_MAP.md` — 5-screen layout with widget types, state-dependent behavior, and SquareLine export notes.
